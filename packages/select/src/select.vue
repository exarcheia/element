...
import {getValueByPath, isEdge, isIE, valueEquals} from 'exarcheia-element/src/utils/util';
...
export default {
  ...
  watch: {
    ...
    selectedLabel: 'debouncedOnInputChange',
  ...
  methods: {
    debouncedQueryChange: _(function() {
      this.handleQueryChange(this.query);
    }, 300),

    debouncedOnInputChange: _(function() {
      this.onInputChange();
    }, 300),
